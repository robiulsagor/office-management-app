...
const AuthWrapper = ({ children, subText }: { children: React.ReactNode; subText: string }) => {
  return (
    <div className="flex flex-col md:flex-row w-full max-w-100  md:min-w-175 mx-auto border border-[#D7E0DF] overflow-hidden bg-white rounded-xl shadow-md min-h-87.5">
